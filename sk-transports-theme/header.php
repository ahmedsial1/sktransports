...
<body <?php body_class(); ?>>
    <div class="top-ticker">
        <div class="ticker-content">
            <div class="ticker-item" data-i18n="ticker_text">PDO Certified Sany Fleet | 18+ Branches Across Oman | Direct Sourcing from China (Used & New Machines) | 24/7 Technical Support</div>
            <div class="ticker-item" data-i18n="ticker_text">PDO Certified Sany Fleet | 18+ Branches Across Oman | Direct Sourcing from China (Used & New Machines) | 24/7 Technical Support</div>
        </div>
    </div>
    <nav id="main-nav">
